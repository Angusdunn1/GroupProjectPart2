#!/usr/bin/env python3
"""
Agent-based disease spread simulation with linear motion and vaccination.
This script creates an animated visualisation of disease spread in a population
where agents move in straight lines and can get vaccinated at a station.
"""
...
def run_agent_with_linear_motion(
